...
function saveadvert(key, id)
{
	...
	} else
	{
		...
		ajax.send("title="+escape(title)+"&tag="+escape(tag)+"&desc="+escape(desc)+"&cat="+cat+"&date="+date+"&poster="+poster+"&hidden="+hidden+"&address1="+address1+"&address2="+address2+"&address3="+address3+"&address4="+address4+"&address5="+address5+"&phone="+phone+"&contact="+contact+"&website="+website+"&image="+image+"&locs="+locs+"&atts="+atts+tried+extra+sendid+"&key="+key);
	}
}
...
function saveadvertprofile(key, id)
{
	...
	} else
	{
		...
		ajax.send("title="+escape(title)+"&tag="+escape(tag)+"&desc="+escape(desc)+"&cat="+cat+"&address1="+address1+"&address2="+address2+"&address3="+address3+"&address4="+address4+"&address5="+address5+"&phone="+phone+"&contact="+contact+"&website="+website+"&image="+image+"&locs="+locs+"&atts="+atts+extra+"&id="+id+"&key="+key);
	}
}
